import { Box, Paper, Typography, Avatar, List, ListItem, ListItemIcon, ListItemText } from '@mui/material';
...
const Sidebar = () => (
  <Box sx={{ width: 235, flexShrink: 0 }} zIndex={1} bgcolor={'white'}>
    <Paper sx={{ width: 235, height: '100vh', position: 'fixed', p: 2, backgroundColor: 'white' }}>
      ...
      <center>
        <Avatar alt="User Name" src="/path-to-image.jpg" sx={{ width: 56, height: 56, mb: 1 }} />
